...
const ImageConverter = () => {
  ...
  const handleDownload = () => {
    if (outputImage) {
      ...
      link.download = 'converted-image by TooDiv.com.' + convertFormat;
      link.click();
    }
  };
  ...
  return (
    <div className="ic-card">
      ...
      <p>
        <img src="https://toodiv.com/wp-content/uploads/2024/04/TooDiv.com_.png" alt="Description" style={{ width: '100px', height: 'auto', marginTop: '20px' }} />
      </p>
